CLASS zcl_rpp_cargas DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rpp_cargas IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    TYPES: tt_product  TYPE TABLE OF ztrpp_product WITH DEFAULT KEY,
           tt_vendor   TYPE TABLE OF ztrpp_vendor WITH DEFAULT KEY,
           tt_company  TYPE TABLE OF ztrpp_company WITH DEFAULT KEY,
           tt_customer TYPE TABLE OF ztrpp_customer WITH DEFAULT KEY.
    ...
    DELETE FROM ztrpp_product.
    DELETE FROM ztrpp_vendor.
    DELETE FROM ztrpp_company.
    DELETE FROM ztrpp_customer.

    MODIFY ztrpp_product FROM TABLE @lt_product.
    MODIFY ztrpp_vendor FROM TABLE @lt_vendor.
    MODIFY ztrpp_company FROM TABLE @lt_company.
    MODIFY ztrpp_customer FROM TABLE @lt_customer.
